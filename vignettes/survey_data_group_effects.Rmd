...
var.type <- c("gaussian", "binary", "gaussian", "binary",
              "gaussian", "binary", "binary", "gaussian",
              "gaussian", "binary", "gaussian", "gaussian",
              "gaussian", "binary", "gaussian", "gaussian",
              "binary", "binary", "gaussian", "binary")
...
```{r estim}
# takes a few minutes
res <- mimi(acs2016$survey, model = "groups", groups = acs2016$fes, var.type = var.type, thresh = 1e-3, lambda1 = 100, lambda2 = 500, maxit = 1e3)
